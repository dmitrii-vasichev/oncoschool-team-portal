...
Архивный основной план реализации: **docs/plans/archive/PLAN.md**
Архивный план переделки модуля «Встречи»: **docs/plans/archive/MEETINGS_PLAN.md**
Архивный план переделки вкладки «Команда»: **docs/plans/archive/TEAM_PLAN.md**

## Правила работы

- **Работаем пофазно.** Одна фаза за сессию. Не забегай вперёд.
- **Перед началом фазы** прочитай архивный план в `docs/plans/archive/` и найди нужную секцию.
- **Не трогай архивные планы в `docs/plans/archive/`.** Эти файлы редактирует только человек.
...
- **Telegram задачи:** inline-only flow (`/tasks` + callback-кнопки).
...
При работе с фронтендом следуй гайдлайнам в `docs/ai/frontend-design.md`.
Исторические промпты по встречам: `docs/plans/archive/MEETINGS_PARTICIPANTS_PROMPTS.md`.
...
### Основной план (docs/plans/archive/PLAN.md) — завершён ✅
...
### Переделка модуля «Встречи» (docs/plans/archive/MEETINGS_PLAN.md) — завершён ✅
...
### Переделка вкладки «Команда» (docs/plans/archive/TEAM_PLAN.md) — завершён ✅
...
### Переделка вкладки «Команда» (docs/plans/archive/TEAM_PLAN.md)
