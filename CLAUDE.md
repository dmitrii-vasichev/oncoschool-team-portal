...
- [ ] Фаза 5: AI мульти-провайдер + парсинг Zoom Summary (/summary)
- [ ] Фаза 6: Голосовые задачи (Whisper STT → AI → превью → задача)
- [ ] Фаза 7: Подписки + напоминания (/subscribe, /reminders, дайджесты)
- [ ] Фаза 8: REST API (все endpoints, auth, CORS)
